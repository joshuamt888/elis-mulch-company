        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white shadow-sm border border-soil-dark/50 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-sand/70 mb-4">Many Victoria homeowners are landscaping new construction or refreshing mature beds. Our installation crews bring expertise and efficiency to every Victoria project. Subscribe for recurring service and enjoy a beautiful yard without the effort.</p>
