  ...
  return (
    <>
      ...
      <section className="relative h-[60vh] min-h-[400px]">
        <Image src="/images/hero/hero-1.webp" alt="Professional mulch installation in Victoria, MN" fill className="object-cover" priority />
