...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://elismulchcompany.com/victoria-mulch-delivery" },
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white shadow-sm border border-soil-dark/50 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-sand/70 mb-4">
                Victoria&apos;s larger lots and newer developments often call for bulk quantities. We offer per-yard pricing that works for homeowners and builders alike.
              </p>
      ...
      <section className="bg-soil py-20">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="text-3xl md:text-4xl font-outfit font-bold text-sand text-center mb-12">
            Why Victoria Homeowners Trust Eli&apos;s Mulch
          </h2>
