    ...
    <>
      ...
      <section className="relative h-[60vh] min-h-[400px]">
        <Image
          ...
          alt="Mulch delivery in Minnetonka, MN"
          fill
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
          <h1 className="text-white text-4xl md:text-5xl font-outfit font-bold max-w-4xl">
            Mulch Delivery &amp; Installation in Minnetonka, MN
          </h1>
          <p className="mt-4 max-w-2xl text-lg text-white/90">
            Premium mulch products delivered and installed across Minnetonka.
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white shadow-sm border border-soil-dark/50 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-sand/70 mb-4">
                Minnetonka homeowners invest in their landscapes. Our professional installation team works with established perennial beds, wooded lots, and expansive estate gardens across the community.
              </p>
            ...
            {[
              {
                ...
                desc: "We're based in Chanhassen, just minutes from Minnetonka. We understand the Lake Minnetonka area's landscaping standards.",
              },
              {
                title: "Same-Day Delivery",
                desc: "Order before noon and receive your mulch the same day. Keep your Minnetonka property looking its best, on schedule.",
              },
              {
                title: "Premium Products",
                desc: "Double-shredded hardwood, fragrant cedar, and playground chips — premium materials for Minnetonka's distinguished properties.",
              },
              {
                title: "Full Installation Available",
                desc: "We'll spread it for you. Our crew delivers a polished finish that matches Minnetonka's high standards.",
              },
            ].map((item) => (
      ...
      <section className="bg-forest py-16">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-outfit font-bold text-white mb-4">
            Ready for Fresh Mulch in Minnetonka?
          </h2>
