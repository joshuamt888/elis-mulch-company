  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white shadow-sm border border-soil-dark/50 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-sand/70 mb-4">Minnetonka homeowners invest in their landscapes. Our professional installation team works with established perennial beds, wooded lots, and expansive estate gardens across the community. Subscribe for recurring service that matches Minnetonka&apos;s high standards.</p>
      ...
      <section className="bg-soil py-20">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="text-3xl md:text-4xl font-outfit font-bold text-sand text-center mb-12">Why Minnetonka Homeowners Trust Mulch Company MN</h2>
