      ...
      <section className="relative h-[60vh] min-h-[400px]">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
          ...
          <div className="mt-8 flex flex-wrap gap-4 justify-center">
            <Link
              href="/estimate"
              className="bg-blossom hover:bg-blossom-dark text-white font-semibold px-6 py-3 rounded-lg transition-colors"
            >
              Price Mulch
            </Link>
            <a
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {nearbyAreas.map((area) => (
              <Link
                key={area.href}
                href={area.href}
                className="bg-soil hover:bg-blossom hover:text-white text-sand font-medium px-4 py-2 rounded-full transition-colors text-sm"
              >
                {area.name}
              </Link>
            ))}
      ...
      <section className="bg-blossom py-16">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="/estimate"
              className="bg-blossom hover:bg-blossom-dark text-white font-semibold px-6 py-3 rounded-lg border-2 border-white transition-colors"
            >
              Price Mulch
            </Link>
            <a
