    ...
    <>
      ...
      <section className="relative h-[60vh] min-h-[400px]">
        <Image
          ...
          alt="Mulch delivery in Waconia, MN"
          fill
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
          <h1 className="text-white text-4xl md:text-5xl font-outfit font-bold max-w-4xl">
            Mulch Delivery &amp; Installation in Waconia, MN
          </h1>
          <p className="mt-4 max-w-2xl text-lg text-white/90">
            Premium mulch products delivered and installed across Waconia.
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white shadow-sm border border-soil-dark/50 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-sand/70 mb-4">
                Waconia homeowners take pride in their lakeshore and residential landscapes. Our crew installs mulch with care, whether you&apos;re refreshing beds near the lake or building out new garden areas.
              </p>
            ...
            {[
              {
                ...
                desc: "We're based in Chanhassen, just minutes from Waconia. Local service with a personal touch.",
              },
              {
                title: "Same-Day Delivery",
                desc: "Order before noon and enjoy fresh mulch by afternoon — more time to enjoy Waconia Lake.",
              },
              {
                title: "Premium Products",
                desc: "Double-shredded hardwood, cedar, and playground chips. Quality that complements Waconia's lakeside properties.",
              },
              {
                title: "Full Installation Available",
                desc: "We'll spread it for you. Spend your day on the lake instead of spreading mulch by hand.",
              },
            ].map((item) => (
      ...
      <section className="bg-forest py-16">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-outfit font-bold text-white mb-4">
            Ready for Fresh Mulch in Waconia?
          </h2>
