    ...
    <>
      ...
      <section className="relative h-[60vh] min-h-[400px]">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
          ...
          <p className="mt-4 max-w-2xl text-lg text-white/90">Professional mulch installation for Waconia homes and businesses. Locally owned, free in-person quotes.</p>
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white shadow-sm border border-soil-dark/50 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-bark mb-4">Waconia homeowners take pride in their lakeshore and residential landscapes. Our crew installs mulch with care, whether you&apos;re refreshing beds near the lake or building out new garden areas. Subscribe and spend your day on the lake instead.</p>
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { title: "Expert Installation", desc: "Recurring installation so your lakeside property always looks its best." },
