    ...
    <>
      ...
      <main className="pt-28 pb-20 bg-white min-h-screen">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-bark-light mb-10">Last updated: January 29, 2026</p>
          ...
          <div className="space-y-10 text-bark leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-3">
                <li>
                  ...
                  <a href="https://policies.google.com/privacy" className="text-bark hover:underline" target="_blank" rel="noopener noreferrer">
                    Privacy Policy
                  </a>
                </li>
                <li>
                ...
                <li>
                  ...
                  <a href="https://privacy.microsoft.com/en-us/privacystatement" className="text-bark hover:underline" target="_blank" rel="noopener noreferrer">
                    Privacy Policy
                  </a>
                </li>
                <li>
                  <strong className="text-sand">Vercel</strong> (hosting) —{" "}
                  <a href="https://vercel.com/legal/privacy-policy" className="text-bark hover:underline" target="_blank" rel="noopener noreferrer">
                    Privacy Policy
                  </a>
                </li>
              </ul>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-3">
                <li>
                  <a href="https://tools.google.com/dlpage/gaoptout" className="text-bark hover:underline" target="_blank" rel="noopener noreferrer">
                    Google Analytics Opt-out Browser Add-on
                  </a>
                </li>
                <li>
                  <a href="https://microsoftedge.microsoft.com/addons/detail/microsoft-clarity/gnldpbnocfnlkkicnaplmkaphfdnlplb" className="text-bark hover:underline" target="_blank" rel="noopener noreferrer">
