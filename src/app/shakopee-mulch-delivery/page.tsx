...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://elismulchcompany.com/shakopee-mulch-delivery" },
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white shadow-sm border border-soil-dark/50 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-sand/70 mb-4">
                With Shakopee&apos;s rapid growth, many homeowners and builders need mulch in volume. We provide bulk delivery by the cubic yard at prices that make sense for large-scale projects.
              </p>
      ...
      <section className="bg-soil py-20">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="text-3xl md:text-4xl font-outfit font-bold text-sand text-center mb-12">
            Why Shakopee Homeowners Trust Eli&apos;s Mulch
          </h2>
