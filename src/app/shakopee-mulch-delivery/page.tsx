  ...
  return (
    <>
      ...
      <section className="relative h-[60vh] min-h-[400px]">
        <Image src="/images/hero/hero-7.webp" alt="Professional mulch installation in Shakopee, MN" fill className="object-cover" priority />
      ...
      <section className="bg-blossom py-16">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-outfit font-bold text-white mb-4">Ready for a Hassle-Free Yard in Shakopee?</h2>
