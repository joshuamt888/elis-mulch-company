...
export const metadata: Metadata = {
  title: "Mulch Delivery & Installation Prior Lake, MN",
  description:
    "Premium mulch delivery and installation in Prior Lake, Minnesota. Bulk mulch, cedar, hardwood, playground chips. Same-day delivery available. Free estimates.",
  alternates: { canonical: "https://elismulchcompany.com/prior-lake-mulch-delivery" },
    ...
    <>
      ...
      <section className="relative h-[60vh] min-h-[400px]">
        <Image
          ...
          alt="Mulch delivery in Prior Lake, MN"
          fill
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
          <h1 className="text-white text-4xl md:text-5xl font-outfit font-bold max-w-4xl">
            Mulch Delivery &amp; Installation in Prior Lake, MN
          </h1>
          <p className="mt-4 max-w-2xl text-lg text-white/90">
            Premium mulch products delivered and installed across Prior Lake.
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="text-3xl md:text-4xl font-outfit font-bold text-sand text-center mb-12">
            Our Mulch Services in Prior Lake
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white shadow-sm border border-soil-dark/50 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-sand/70 mb-4">
                Prior Lake&apos;s lake community south of Shakopee features beautiful waterfront and residential properties. We deliver premium mulch to homes around Prior Lake, Spring Lake, and all surrounding neighborhoods.
              </p>
            ...
            <div className="bg-white shadow-sm border border-soil-dark/50 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-sand/70 mb-4">
                Prior Lake properties range from cozy lakeside cabins to modern suburban homes. Our crew tailors every installation to the property, ensuring clean edges and proper depth for lasting results.
              </p>
            ...
            <div className="bg-white shadow-sm border border-soil-dark/50 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-sand/70 mb-4">
                Prior Lake&apos;s spacious lakefront lots and newer subdivisions often need mulch in bulk. We deliver by the cubic yard at prices that keep your landscaping project on budget.
              </p>
      ...
      <section className="bg-soil py-20">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="text-3xl md:text-4xl font-outfit font-bold text-sand text-center mb-12">
            Why Prior Lake Homeowners Trust Eli&apos;s Mulch
          </h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                title: "Based Right Here",
                desc: "We're based in Chanhassen, just minutes from Prior Lake via Highway 13. Quick, reliable local service.",
              },
              {
                title: "Same-Day Delivery",
                desc: "Order before noon and have mulch delivered same day. More time to enjoy Prior Lake's waterfront lifestyle.",
              },
              {
                title: "Premium Products",
                desc: "Double-shredded hardwood, cedar, and playground chips. Premium products for Prior Lake's lakeside landscapes.",
              },
              {
                title: "Full Installation Available",
                desc: "We'll spread it for you. Spend your day on the lake instead of lugging wheelbarrows of mulch.",
              },
            ].map((item) => (
      ...
      <section className="bg-forest py-16">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-outfit font-bold text-white mb-4">
            Ready for Fresh Mulch in Prior Lake?
          </h2>
