    ...
    <>
      ...
      <section className="relative h-[60vh] min-h-[400px]">
        <Image
          ...
          alt="Mulch delivery in Savage, MN"
          fill
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
          <h1 className="text-white text-4xl md:text-5xl font-outfit font-bold max-w-4xl">
            Mulch Delivery &amp; Installation in Savage, MN
          </h1>
          <p className="mt-4 max-w-2xl text-lg text-white/90">
            Premium mulch products delivered and installed across Savage.
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white shadow-sm border border-soil-dark/50 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-sand/70 mb-4">
                Whether your Savage home backs up to the Minnesota Valley National Wildlife Refuge or sits in a newer subdivision, our crews deliver expert mulch installation that enhances your curb appeal.
              </p>
            ...
            {[
              {
                ...
                desc: "We're based in Chanhassen, just minutes from Savage. Fast delivery times and true local knowledge.",
              },
              {
                title: "Same-Day Delivery",
                desc: "Order before noon and get mulch the same day. Keep your Savage landscaping project on track.",
              },
              {
                title: "Premium Products",
                desc: "Double-shredded hardwood, cedar, and playground chips. Quality materials for Savage's thriving neighborhoods.",
              },
              {
                title: "Full Installation Available",
                desc: "We'll spread it for you. Save hours of work and enjoy the Minnesota River trails instead.",
              },
            ].map((item) => (
      ...
      <section className="bg-forest py-16">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-outfit font-bold text-white mb-4">
            Ready for Fresh Mulch in Savage?
          </h2>
